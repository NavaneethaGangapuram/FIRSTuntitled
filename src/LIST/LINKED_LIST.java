...
public class LINKED_LIST {
    public static void main(String[] args){
        ...
        subjects.addFirst("SPPM");
        System.out.println(subjects);
        System.out.println("###############################ADDLast#################################");
        subjects.addLast("Devops");
        System.out.println(subjects);
        ...
        System.out.println("###############################ADD#################################");
        System.out.println("###############################getfirst&LAST#################################");
        System.out.println(subjects.getFirst());
        System.out.println(subjects.getLast());
        System.out.println(subjects);
        ...
        System.out.println(subjects);
        System.out.println("###############################REMOVEFIRST AND LAST#################################");
        System.out.println(subjects.removeFirst());
